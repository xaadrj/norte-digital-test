...
export default function index() {
  const Client = ['Apple', 'Banana', 'Cherry', 'Durian', 'Elderberry'];


  return (
    <div className='overflow-auto flex justify-center flex-col items-start mx-auto h-full py-12 px-4 sm:px-6 md:px-12 2xl:px-32 xl:container'>
      ...
      <form className='w-full mt-10'>
        <div className='w-full'>
          ...
          <div className='flex mt-3 justify-start items-end xl:gap-8 gap-4'>
            ...
            <button type="button" className='h-9 m-0 bg-[#279AFF] px-5 flex hover:bg-[#147CC9] justify-center items-center'>
              <img className="w-3" src="/svg/cross.svg" alt="" />
            </button>
          </div>
          <button type="button" className='mt-5 py-2 text-white text-center bg-[#279AFF] px-7 flex hover:bg-[#147CC9]'>Add</button>
